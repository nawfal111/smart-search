...
//            functions → GPT pinpoints the exact line → results show score,
...
//   - plain English summary (generated by GPT at index time)
//   - matched line (pinpointed by GPT at search time — green arrow → line N)
...
function renderAiResults(data) {
  ...
  results.forEach((r) => {
    ...
    // Show the specific matched line if GPT found one, otherwise show code preview
